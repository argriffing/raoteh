...
This module allowed relatively complicated observations.
This is a thin wrapper that uses _mcz to get the node_to_pmap from
...
from raoteh.sampler import _mcz, _sample_mc0


__all__ = []

def resample_states(T, root,
        node_to_state_to_likelihood=None, root_distn=None, P_default=None):
    """
    ...
    node_to_pmap = _mcz.get_node_to_pmap(T, root,
