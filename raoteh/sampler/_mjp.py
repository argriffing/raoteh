...
#TODO under destruction on account of moving into _graph_transform
#TODO use this function in _graph_transform.add_trajectories()
def xxx_get_event_map(T_base, root, traj):
    """
